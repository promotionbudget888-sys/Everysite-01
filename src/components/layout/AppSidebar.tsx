      ...
      <SidebarFooter className="p-4 border-t border-sidebar-border">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <Badge variant="outline" className={`text-xs bg-sidebar-accent border-sidebar-border ${isSpecialUser(profile?.email) ? 'aura-name border-amber-400/50' : profile?.role === 'admin' ? 'aura-blue border-sky-400/50' : 'text-sidebar-muted'}`}>
